    ...
    createDropdown: function () {
      ...
      drop =
        '<div class="dropdown bootstrap-select' + showTick + inputGroup + '">' +
          '<button style="border: 1px solid #ced4da;" type="button" class="' + this.options.styleBase + ' dropdown-toggle" ' + (this.options.display === 'static' ? 'data-display="static"' : '') + 'data-toggle="dropdown"' + autofocus + ' role="combobox" aria-owns="' + this.selectId + '" aria-haspopup="listbox" aria-expanded="false">' +
