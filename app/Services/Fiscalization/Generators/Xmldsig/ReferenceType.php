...
class ReferenceType
{
    ...
    /**
     * @var \App\Services\Fiscalization\Generators\Xmldsig\Transform[] $transforms
     */
    private $transforms = null;

    /**
     * @var \App\Services\Fiscalization\Generators\Xmldsig\DigestMethod $digestMethod
     */
     ...
     */
    public function addToTransforms(\App\Services\Fiscalization\Generators\Xmldsig\Transform $transform)
    {
     ...
     *
     * @param \App\Services\Fiscalization\Generators\Xmldsig\Transform[] $transforms
     * @return self
     */
     ...
     *
     * @return \App\Services\Fiscalization\Generators\Xmldsig\DigestMethod
     */
     ...
     *
     * @param \App\Services\Fiscalization\Generators\Xmldsig\DigestMethod $digestMethod
     * @return self
     */
    public function setDigestMethod(\App\Services\Fiscalization\Generators\Xmldsig\DigestMethod $digestMethod)
    {
