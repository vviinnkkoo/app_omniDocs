...
namespace App\Services\Fiscalization\Generators\RacunPDZahtjev;
...
class RacunPDZahtjevAType
{
    ...
    /**
     * @var \App\Services\Fiscalization\Generators\RacunPDType $racun
     */
    private $racun = null;
     ...
     * Sets a new racun
     *
     * @param \App\Services\Fiscalization\Generators\RacunPDType $racun
     * @return self
     */
    public function setRacun(\App\Services\Fiscalization\Generators\RacunPDType $racun)
    {
        $this->racun = $racun;
        return $this;
    }
