...
namespace App\Services\Fiscalization\Generators\NapojnicaZahtjev;

/**
 * Class representing NapojnicaZahtjevAType
 */
class NapojnicaZahtjevAType
{
    /**
    ...
    /**
     * @var \App\Services\Fiscalization\Generators\RacunNapojnicaType $racun
     */
    private $racun = null;
     ...
     * Gets as racun
     *
     * @return \App\Services\Fiscalization\Generators\RacunNapojnicaType
     */
     ...
     * Sets a new racun
     *
     * @param \App\Services\Fiscalization\Generators\RacunNapojnicaType $racun
     * @return self
     */
    public function setRacun(\App\Services\Fiscalization\Generators\RacunNapojnicaType $racun)
    {
        $this->racun = $racun;
        return $this;
    }
