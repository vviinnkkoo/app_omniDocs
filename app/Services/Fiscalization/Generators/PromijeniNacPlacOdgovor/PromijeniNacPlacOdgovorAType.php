...
namespace App\Services\Fiscalization\Generators\PromijeniNacPlacOdgovor;

/**
 * Class representing PromijeniNacPlacOdgovorAType
 */
class PromijeniNacPlacOdgovorAType
{
    /**
