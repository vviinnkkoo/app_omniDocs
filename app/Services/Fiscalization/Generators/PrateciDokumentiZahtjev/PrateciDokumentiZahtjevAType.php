...
namespace App\Services\Fiscalization\Generators\PrateciDokumentiZahtjev;
...
class PrateciDokumentiZahtjevAType
{
    ...
    /**
     * @var \App\Services\Fiscalization\Generators\PrateciDokumentType $prateciDokument
     */
     ...
     *
     * @return \App\Services\Fiscalization\Generators\PrateciDokumentType
     */
     ...
     *
     * @param \App\Services\Fiscalization\Generators\PrateciDokumentType $prateciDokument
     * @return self
     */
    public function setPrateciDokument(\App\Services\Fiscalization\Generators\PrateciDokumentType $prateciDokument)
    {
