...
<div class="modal fade" id="addDeliveryServiceModal" tabindex="-1" aria-labelledby="addDeliveryServiceModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addDeliveryServiceModalLabel">Nova dostavna usluga</h5>
